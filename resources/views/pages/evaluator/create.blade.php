...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-header">
            <a href="/evaluator" class="btn btn-icon icon-left btn-primary"><i
                    class="fas fa-arrow-alt-circle-left
        "></i> Retour</a>
            &nbsp;&nbsp;
            <h3 class="card-title">Formulaire d'inscription d'un evaluateur</h3>
        </div>
        <form action="/evaluator" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="matriculate" required class="form-control rounded-0"
                        id="exampleInputRounded0" placeholder="Matricule">
                </div>

                <div class="form-group">
                    <label for="exampleInputRounded0">Nom(s) </label>
                    <input type="text" name="name" required class="form-control rounded-0" id="exampleInputRounded0"
                        placeholder="Nom(s)">
                </div>

                <div class="form-group">
                    <label for="exampleInputRounded0">Prenom(s)</label>
                    <input type="text" name="first_name" required class="form-control rounded-0"
                        id="exampleInputRounded0" placeholder="Prenom(s)">
                </div>

                <div class="form-group">
                    <label for="exampleInputRounded0">Email</label>
                    <input name="email" type="mail" required class="form-control rounded-0" id="exampleInputRounded0"
                        placeholder="Email">
                </div>
